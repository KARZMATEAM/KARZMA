...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./KARZMA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("KA", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S KARZMA -X kill
screen -S KARZMA ./KARZMA
done
]])  
file:close() 
...
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
var = database:get(bot_id.."DEV:Sudo:T"..msg.chat_id_) or 'مطور الاساسي²'  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
...
--------------------------------------------------------------------------------------------------------------
function SourceKARZMA(msg,data) -- بداية العمل
if msg then
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫∫ [تحديثات البوت](t.me/GG_GQ) \n ✫∫ [قناه السورس](t.me/RIRRR9)')
end
...
≪━━━━━━𝐊𝐀━━━━━━≫
 ✫∫ ↬TeAm KaRzMa
≪━━━━━━𝐊𝐀━━━━━━≫
 ✫∫ ↬[Channel KARZMA](t.me/RIRRR9) 
≪━━━━━━𝐊𝐀━━━━━━≫
 ✫∫ ↬[Information](t.me/GG_GQ)
≪━━━━━━𝐊𝐀━━━━━━≫
 ✫∫ ↬[DEVELOPER](t.me/BH_HM1)
≪━━━━━━𝐊𝐀━━━━━━≫
 ✫∫ ↬[To talk to us](t.me/TAEGR_BOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
database:set(bot_id.."DEV:Sudo:T"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," ✫∫ تم تغير رد مطور الاساسي² الى » "..Teext)
end
