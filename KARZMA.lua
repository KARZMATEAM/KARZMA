...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KARZMATEAM/Files_Karzma/main/File_Bot/commands.lua")
...
if hash or SudoBot(msg) or DevKARZMAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKARZMAW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKARZMAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKARZMAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKARZMAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKARZMAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKARZMAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "RIRRR9")
...
local KARZMA_Msg = ''  
if msgs < 100 then 
KARZMA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KARZMA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KARZMA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KARZMA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KARZMA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KARZMA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KARZMA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KARZMA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KARZMA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KARZMA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KARZMA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KARZMA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KARZMA_Msg = 'رب التفاعل'  
end 
return KARZMA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKARZMA(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'كارزما')
SourceKARZMAr = '*✫∫ اهلا عزيزي*\n*✫∫ انا بوت اسمي '..Namot..'*\n*✫∫ اختصاصي حمايه الكروبات*\n*✫∫ من تكرار والسبام والتوجيه والخ…*\n*✫∫ لتفعيلي اتبع الاخطوات…↓*\n*✫∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n✫∫ [قناة سورس البوت](http://t.me/RIRRR9)'
end
send(msg.chat_id_, msg.id_, SourceKARZMAr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevKARZMAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevKARZMAW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,KARZMA_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✫' and DevKARZMAW(msg) then  
...
if text == 'تعطيل التواصل ✫' and DevKARZMAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and DevKARZMAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and DevKARZMAW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and DevKARZMAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✫∫ ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and DevKARZMAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✫∫ تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and DevKARZMAW(msg) then 
...
send(msg.chat_id_, msg.id_,' *✫∫ تم تحديث السورس* \n*✫∫ لديك اخر اصدار لسورس كارزما*\n*✫∫ الاصدار » { 2.8v}*')
dofile('KARZMA.lua')  
end
if text == 'الاصدار ✫' and DevKARZMAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✫∫ اصدار سورس كارزما* \n*✫∫ الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✫' and DevKARZMAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫∫ [تحديثات البوت](t.me/RIRRR9) \n✫∫ [قناه السورس](t.me/RIRRR9)')
end
if text == "ضع اسم للبوت ✫" and DevKARZMAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✫' and DevKARZMAW(msg) then 
...
if text == 'المشتركين ✫' and DevKARZMAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫∫ المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✫' and DevKARZMAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫∫ الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and DevKARZMAW(msg) then
...
if text == ("قائمه العام ✫") and DevKARZMAW(msg) then
...
if text == ("قائمه الكتم العام ✫") and DevKARZMAW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and DevKARZMAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل الان اذاعتك؟* \n*✫∫ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and DevKARZMAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل الان اذاعتك؟* \n*✫∫ للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and DevKARZMAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل الان اذاعتك؟* \n*✫∫ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and DevKARZMAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and DevKARZMAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and DevKARZMAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and DevKARZMAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✫" and DevKARZMAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*✫∫ عدد الكروبات الان » { '..#group..' }'..KARZMAk..''..KARZMA..'*\n*✫∫ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevKARZMAW(msg) then
...
usertext = '*\n ✫∫ العضو »* ['..result.title_..'](t.me/'..(username or 'RIRRR9')..')'
status  = '\n *✫∫ تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevKARZMAW(msg) then
...
usertext = '\n *✫∫ العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RIRRR9')..')'
status  = '\n*✫∫ تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevKARZMAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevKARZMAW(msg) then
...
local KARZMA1_Msg = database:get(bot_id.."KARZMA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KARZMA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫∫ العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'RIRRR9')..') \n ✫∫ '..KARZMA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if KARZMA_Msg and not Special(msg) then  
local KARZMA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KARZMA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫∫ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫∫ ["..KARZMA_Msg.."] \n")
else
send(msg.chat_id_,0," *✫∫ العضو :* {["..data.first_name_.."](T.ME/RIRRR9)}\n✫∫ ["..KARZMA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " *✫∫ عذرا »* {["..data.first_name_.."](T.ME/RIRRR9)}\n*✫∫ عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevKARZMAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevKARZMAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevKARZMAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫∫ حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevKARZMAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫∫ حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and DevKARZMAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✫∫ تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and DevKARZMAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫∫ حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and DevKARZMAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and DevKARZMAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✫∫ تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and DevKARZMAW(msg) then  
...
database:sadd(bot_id.."KARZMA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."KARZMA:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_KARZMA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_KARZMA then 
names_KARZMA = database:smembers(bot_id.."KARZMA:blocname"..msg.chat_id_) or ""
if names_KARZMA and names_KARZMA[1] then 
for i=1,#names_KARZMA do 
if name_KARZMA:match("(.*)("..names_KARZMA[i]..")(.*)") then 
...
database:set(bot_id.."KARZMA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."KARZMA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."KARZMA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."KARZMA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."KARZMA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_KARZMAa_new(KARZMA1,KARZMA2)
if KARZMA2 and KARZMA2.first_name_ then 
if KARZMA2.first_name_:match("(.*)"..database:get(bot_id.."KARZMA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KARZMA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local KARZMA_nnn = database:get(bot_id.."KARZMA:nump"..msg.chat_id_) or 5
local KARZMA_nnn2 = database:get(bot_id.."KARZMA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(KARZMA_nnn2) == tonumber(KARZMA_nnn) or tonumber(KARZMA_nnn2) > tonumber(KARZMA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KARZMA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✫∫ عزيزي >>["..KARZMA2.username_.."](https://t.me/"..(KARZMA2.username_ or "RIRRR9")..")\n✫∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KARZMA:teh"..msg.chat_id_).."} بجانب اسمك\n✫∫ عدد المحاولات المتبقيه {"..(tonumber(KARZMA_nnn) - tonumber(KARZMA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_KARZMAa_new)
end
end
...
local KARZMAChengName = database:get(bot_id.."KARZMA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KARZMAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KARZMAChengName..']')
database:del(bot_id.."KARZMA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KARZMAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."KARZMA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KARZMAChengUserName = database:get(bot_id.."KARZMA:Cheng:UserName"..data.id_)
if not data.username_ then 
if KARZMAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KARZMAChengUserName..']')
database:del(bot_id.."KARZMA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KARZMAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."KARZMA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KARZMAChengPhoto = database:get(bot_id.."KARZMA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KARZMAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."KARZMA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KARZMAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."KARZMA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
*أهلاً بك في السوࢪس* [TeAm KaRzMa💘](t.me/RIRRR9)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس 💘',url="https://t.me/RIRRR9"},
},
{
{text = 'لتنصيب السوࢪس 💘',url="https://t.me/RIRRR9/3"},
},
{
{text = 'تواصل السوࢪس 💘',url="t.me/TAEGR_BOT"},
},
{
{text = 'مطوࢪ السوࢪس 💘',url="t.me/BH_HM1"},
},
}
...
if text == 'رفع نسخه الاحتياطيه' and DevKARZMAW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫∫ بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'RIRRR9')..') \n*✫∫ تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevKARZMAW(msg) then    
dofile('KARZMA.lua')  
send(msg.chat_id_, msg.id_, ' *✫∫ تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevKARZMAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevKARZMAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if KARZMASudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevKARZMAW(msg) then
...
if KARZMASudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✫∫ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevKARZMAW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevKARZMAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevKARZMAW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevKARZMAW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevKARZMAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevKARZMAW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevKARZMAW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevKARZMAW(msg) then
...
if text == 'الملفات' and DevKARZMAW(msg) then
t = ' *✫∫ ملفات السورس كارزما ↓*\n*•━━━━━━ 𝐊𝐀 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevKARZMAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KARZMATEAM/Files_Karzma/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✫∫ اهلا بك في متجر ملفات كارزما*\n*✫∫ ملفات السورس ↓*\n*•━━━━━━ 𝐊𝐀 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝐊𝐀 ━━━━━━━•*\n *✫∫ علامة تعني { ✓ } ملف مفعل*\n *✫∫ علامة تعني { ✘ } ملف معطل*\n *✫∫ قناة سورس كارزما ↓*\n".." *✫∫ *[اضغط هنا لدخول](t.me/RIRRR9) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevKARZMAW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/KARZMATEAM/Files_Karzma/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('KARZMA.lua')  
else
send(msg.chat_id_, msg.id_," *✫∫ عذرا الملف لايدعم سورس كارزما* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevKARZMAW(msg) then
...
if text == "مسح الملفات" and DevKARZMAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✫∫ تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevKARZMAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevKARZMAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "RIRRR9")
...
function Function_KARZMA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_KARZMA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_KARZMA, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✫∫ لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RIRRR9')..')'
status  = '\n*✫∫ تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✫∫ العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫∫ العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RIRRR9')..')'
...
database:set(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✫∫ ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KARZMA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KARZMA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✫∫ تم منع الكلمه مع التحذير*")  
database:del(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KARZMA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KARZMA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KARZMA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✫∫ ارسل الكلمه الان*")  
database:set(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KARZMA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KARZMA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KARZMA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KARZMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KARZMA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KARZMA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *✫∫ قائمة المنع* \n*•━━━━━━ 𝐊𝐀 ━━━━━━━•*\n"
for k,v in pairs(list) do  
local KARZMA_Msg = database:get(bot_id.."KARZMA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..KARZMA_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevKARZMAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✫∫ تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevKARZMAW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✫∫ العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'RIRRR9')..')'..'\n*✫∫ تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevKARZMAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevKARZMAW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كارزما').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كارزما')
local KARZMA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..KARZMA_Msg[math.random(#KARZMA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevKARZMAW(msg) then 
...
if KARZMASudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevKARZMAW(msg) then 
...
if text == ("ردود المطور") and DevKARZMAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✫∫ قائمة ردود المطور \n*•━━━━━━ 𝐊𝐀 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevKARZMAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevKARZMAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كارزما').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevKARZMAW(msg) then   
...
if text == 'تعطيل المغادره' and DevKARZMAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✫∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KARZMA')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'RIRRR9')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
KARZMAdx(msg.chat_id_, msg.id_, ' *✫∫ ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✫∫ عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✫∫ عدد المحظورين » ( '..data.kicked_count_..' )*\n*✫∫ عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevKARZMAW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ*•━━━━━━ 𝐊𝐀 ━━━━━━━•*ٴ✫∫○ٴ\n✫∫ [TeAm KaRzMa](t.me/RIRRR9) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'TeAm KaRzMa.',url="t.me/RIRRR9"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كارزما')
...
KARZMA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KARZMA)
...
--------------------------------------------------------------------------------------------------------------
SourceKARZMA(data.message_,data)
...
------------------------------------------------------------------------
local KARZMAAbot = database:get(bot_id.."KARZMA1:Add:Filter:Rp2"..text..result.chat_id_)   
if KARZMAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫∫ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫∫ ["..KARZMAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KARZMA1_Msg = database:get(bot_id.."KARZMA1:Add:Filter:Rp2"..text..result.chat_id_)   
if KARZMA1_Msg then    
send(msg.chat_id_, msg.id_," ✫∫ "..KARZMA1_Msg)
